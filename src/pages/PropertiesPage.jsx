...
import InteriorEstimatorWizard from "./InteriorEstimatorWizard";
...
const PropertiesPage = ({ category }) => {
  ...
  useEffect(() => {
    ...
    if (activeFilters.size !== "all") {
      filtered = filtered.filter(
        (property) => property.size === activeFilters.size
      );
    }
      ...
      <div className="bg-gray-50 py-12">
        <div className="container-custom">
          ...
          <p className="text-secondary-600 max-w-3xl">
            Browse our collection of {pageTitle.toLowerCase()} designed by
            professional architects. Find the perfect design for your dream
            home.
          </p>
        </div>
      </div>
      <div className="bg-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Full Home */}
            <div className="border rounded-lg shadow p-6 text-left">
              <div className="flex items-center mb-4">
                <img src={home} alt="Full Home" className="w-10 h-10 mr-2" />
                <h3 className="text-xl font-semibold">Full Home</h3>
              </div>
            ...
            <div className="border rounded-lg shadow p-6 text-left">
              <div className="flex items-center mb-4">
                <img src={home} alt="Kitchen" className="w-10 h-10 mr-2" />
            ...
            <div className="border rounded-lg shadow p-6 text-left">
              <div className="flex items-center mb-4">
                <img src={home} alt="Wardrobe" className="w-10 h-10 mr-2" />
                <h3 className="text-xl font-semibold">Wardrobe</h3>
              </div>
              <p className="text-gray-600 mb-4">
      ...
      <div className="container-custom py-8">
        ...
        <div className="flex justify-between items-center mb-6 lg:hidden">
          ...
          <div className="flex items-center gap-2">
            <label htmlFor="mobile-sort" className="text-secondary-700">
              Sort:
            </label>
            <select
              id="mobile-sort"
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          {/* Filters Sidebar */}
          <div
            className={`lg:w-1/4 bg-white p-6 rounded-lg shadow-md self-start ${
          ...
          >
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={() =>
                        handleFilterChange("category", "elevations")
                      }
                      className="mr-2"
                    />
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={() =>
                        handleFilterChange("category", "interiors")
                      }
                      className="mr-2"
                    />
                    <span>Interiors</span>
                ...
                {[2, 3, 4, 5].map((num) => (
                  <label key={num} className="flex items-center">
                    <input
                      ...
                      onChange={() =>
                        handleFilterChange("bedrooms", num.toString())
                      }
                      className="mr-2"
                    />
                    <span>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2">
                ...
                {["20x40", "30x50", "30x60", "40x60", "40x80", "60x90"].map(
                  (size) => (
              ...
              <div className="space-y-2">
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleFilterChange("priceRange", "under20k")
                    }
                    className="mr-2"
                  />
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={() =>
                      handleFilterChange("priceRange", "above50k")
                    }
                    className="mr-2"
                  />
          ...
          <div className="lg:w-3/4">
            <div className="flex justify-between items-center mb-6 hidden lg:flex">
              ...
              <div className="flex items-center gap-3">
                <label htmlFor="desktop-sort" className="text-secondary-700">
                  Sort by:
                </label>
                <select
                  id="desktop-sort"
